...
export default function App() {
    ...
    useEffect(() => {
        const imageUri =
            'https://akcdn.detik.net.id/visual/2020/10/31/ebel_169.jpeg?w=900&q=90';

        Image.getSize(imageUri, (width, height) => {
            Image.prefetch(imageUri).then(() => {
                Image.resolveAssetSource({ uri: imageUri }).then((source) => {
                    ...
                    image.onload = function () {
                        ...
                        const textColor = isDarkColor(dominantColor)
                            ? '#ffffff'
                            : '#000000';
    ...
    const isDarkColor = ([r, g, b]) => {
        // Formula untuk menentukan apakah warna adalah warna gelap atau terang
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View
                ...
                <View>
                    <Text style={{ fontSize: 35, marginBottom: 8, color: textColor }}>
                        Daily mission :
                    </Text>
                    <View
                        style={{
                        ...
                        <View
                            ...
                            <View
                                ...
                                <Text
                                    style={{ fontSize: 15, color: backgroundColor, zIndex: 1 }}>
                                    {DATA[0].location}
                                </Text>
                            </View>
                            <Text
